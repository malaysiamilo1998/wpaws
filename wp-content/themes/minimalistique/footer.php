	...
	<div class="site-info">
		...
		<?php else : ?>
			...
			<span class="footer-info-right">
				<?php echo __(' | WordPress Theme by', 'minimalistique') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'minimalistique'); ?>" rel="nofollow noopener"><?php echo __(' SuperbThemes', 'minimalistique') ?></a>
			</span>
