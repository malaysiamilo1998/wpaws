...
<div id="content" class="site-content clearfix">
	<?php $minimalistique_theme_container_class = !is_page_template('elementor_header_footer') ? 'content-wrap' : 'content-none'; ?>
			...
			<main id="main" class="fbox site-main">
				<section class="error-404 not-found bg-image-404">
					<header class="page-header">
						<h1 class="page-title error-404-headline"><?php esc_html_e('Ooops!', 'minimalistique'); ?></h1>
						<p class="error-404-description"><?php esc_html_e('It seems like this page is no longer here', 'minimalistique'); ?></p>
					</header><!-- .page-header -->

					<div class="page-content">
						<div class="fourofour-home">
							<a href="<?php echo  esc_url(home_url()); ?>"><?php esc_html_e('Go to homepage', 'minimalistique'); ?></a>
						</div>
					</div><!-- .page-content -->
				...
				<?php if (CustomizerControls::GetSelectedOrDefault(CustomizerControls::PAGE_404_HIDE_POSTS) != "1") : ?>
					<section class="error-404 try-new-posts">
						<h2 class="try-new-post-headline"><?php esc_html_e('Recent Posts', 'minimalistique'); ?></h2>
