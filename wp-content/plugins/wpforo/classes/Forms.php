	...
	public function field_avatar( $f ) {
		...
		$field_html = '<ul>
				...
				<li>
				    ...
				    <input autocomplete="off" name="' . esc_attr( $f['varname'] ) . '[avatar_url]" value="' . esc_url( preg_replace('|^//|is', $protocol, (string) $remote_url) ) . '" maxlength="300" data-wpfucf-minmaxlength="1,300" type="url" />
				</li>';
