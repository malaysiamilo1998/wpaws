...
<div class="wpfl-3 wpforo-section">
    ...
    foreach($forums as $key => $forum) :
        ...
        $topics = WPF()->topic->get_topics( apply_filters( 'wpforo_tpl_l3_forum_loop_intro_topics_get_args', array("forumid" => $forum['forumid'], "orderby" => "type, modified", "order" => "DESC", "row_count" => wpforo_setting( 'forums', 'layout_qa_intro_topics_count' ) ) ) );
