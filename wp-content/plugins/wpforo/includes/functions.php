...
function wpforo_content_filter( $content ) {
	...
	if( apply_filters( 'wpforo_auto_embed_image', true ) ) $content = preg_replace( '#([^\'\"]|^)(https?://[^\s\'\"<>]+\.(?:jpg|jpeg|png|webp|gif|svg|bmp|tiff))([^\'\"]|$)#iu', '$1 <a class="wpforo-auto-embeded-link" href="$2" target="_blank"><img class="wpforo-auto-embeded-image" src="$2"/></a> $3', (string) $content );
	if( apply_filters( 'wpforo_auto_embed_link', true ) ) $content = preg_replace( '#([^\'\"]|^)(https?://[^\s\'\"<>\[\]]+)([^\'\"]|$)#iu', '$1 <a class="wpforo-auto-embeded-link" href="$2" target="_blank">$2</a> $3', (string) $content );
 ...
 * @param $type string
 * @param $wp_date_format bool
 * @param $timezone string
 *
 * @return string
 */
function _wpforo_date( $date = 0, $type = 'Y-m-d H:i:s', $wp_date_format = false, $timezone = '' ){
	date_default_timezone_set( 'UTC' );
	ini_set( 'date.timezone', 'UTC' );

    if( ! $date ) $date = current_time( 'timestamp', 1 );
...
function wpforo_date( $date, $type = 'ago', $echo = true, $wp_date_format = true ) {
	$d = _wpforo_date( $date, $type, $wp_date_format, (string) wpfval( WPF()->current_user, 'timezone' ) );
...
function wpforo_urlencode( $str ) {
	...
	return $str !== urldecode( (string) $str ) ? strtolower( (string) $str ) : $str;
}
